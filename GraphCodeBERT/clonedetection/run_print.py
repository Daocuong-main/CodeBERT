...
def convert_examples_to_features(item):
    # source
    # print("Inside convert_examples_to_features")
    ...
    # print(f"args: {args}")
    # print(f"cache: {cache}")
    # print(f"url_to_code: {url_to_code}")
    parser = parsers['java']
    ...
    # print(f"source_tokens_1: {source_tokens_1}")
    # print(f"source_ids_1: {source_ids_1}")
    # print(f"position_idx_1: {position_idx_1}")
    # print(f"dfg_to_code_1: {dfg_to_code_1}")
    # print(f"dfg_to_dfg_1: {dfg_to_dfg_1}")
    # print(f"source_tokens_2: {source_tokens_2}")
    # print(f"source_ids_2: {source_ids_2}")
    # print(f"position_idx_2: {position_idx_2}")
    # print(f"dfg_to_code_2: {dfg_to_code_2}")
    # print(f"dfg_to_dfg_2: {dfg_to_dfg_2}")
...
class TextDataset(Dataset):
    def __init__(self, tokenizer, args, file_path='train'):
        ...
        # print(f"url to code: {url_to_code}")
        ...
        # print("convert example to input features")
